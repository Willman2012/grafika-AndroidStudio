...
public class ContinuousCaptureActivity extends Activity implements SurfaceHolder.Callback,
    ...
    private void openCamera(int desiredWidth, int desiredHeight, int desiredFps) {
        ...
        CameraUtils.choosePictureSize(parms, desiredWidth, desiredHeight);
    ...
    private void drawFrame() {
        Log.d(TAG, "camera capture incoming frame drawFrame");
        if (mEglCore == null) {
        ...
        if((System.currentTimeMillis()-last_Timestamp)>5000)
        {
            ...
            Log.d(TAG, "updated drawFrame for 5 seconds, fps=" + fps);
        }
