...
public class MoviePlayer {
    ...
    public void play() throws IOException {
        ...
        try {
            ...
            MediaFormat format = extractor.getTrackFormat(trackIndex);
            Log.d(TAG, "MoviePlayer decode format: " + format);
    ...
    private void doExtract(MediaExtractor extractor, int trackIndex, MediaCodec decoder,
        ...
        while (!outputDone) {
            ...
            if (!outputDone) {
                ...
                Log.d(TAG, "doExtract  decoderStatus: " + decoderStatus);
                if (decoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                    ...
                    Log.d(TAG, "surface decoder given buffer " + decoderStatus +
                            " (size=" + mBufferInfo.size + ")  OutputFrame "+ OutputFrame + " mBufferInfo.presentationTimeUs: "+mBufferInfo.presentationTimeUs);
